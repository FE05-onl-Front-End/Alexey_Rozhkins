...
prompt('Имя Короля?');
prompt('потери армии короля?');
prompt('сколько было воинов в армии короля?');
prompt('сколько врагов было?');
prompt('сколько враги потеряли воинов?');
